                    ...
                    {{method_field('PUT')}}
                      ...
                      <div class="card-body">
                        <div class="row">
                          ...
                          <div class="form-group col-md-6 col-12">
                            <label>Company</label>
                            <input type="text" class="form-control" name="company" value="{{$account->company}}">
                          </div>
                        </div>
                        <div class="row">
                          <div class="form-group col-md-6 col-12">
                            <label>Branch</label>
                            <input type="text" class="form-control" name="branch" value="{{$account->branch}}">
                          </div>
                          <div class="form-group col-md-6 col-12">
                            <label for="account_no">Account No</label>
                            <input type="number" class="form-control" name="account_no" value="{{$account->account_no}}">
                          </div>
                        </div>
                        <div class="row">
                            <div class="form-group col-md-6 col-12">
                            ...
                            <div class="form-group col-md-6 col-12">
                                ...
                                <input type="number" class="form-control" name="balance" value="{{$account->balance}}">
                              </div>
                          </div>
