              ...
              <div class="col-12">
                <div class="card">
                  ...
                  <div class="pull-right" style="margin-right:25px;margin-top:10px;">
                    <a href="{{route('transactions.create')}}" class="btn btn-outline-primary pull-right">Add Transaction</a>
                  </div>
              <div class="card-body">
                  ...
                  <table class="table table-striped table-hover" id="save-stage" style="width:100%;">                   
                    ...
                    <tbody>
                      ...
                      <tr>
                        ...
                        <td>{{$transaction->account->company}}</td>
                        <td>{{auth()->user()->usertype}}</td>
                        <td>
                        <a class="btn btn-outline-info" href="/transactions/{{$transaction->id}}/edit">Edit</a>
                        <form action="{{route('transactions.destroy', $transaction->id)}}" method="POST">
                                {{ csrf_field() }}
                                {{ method_field('DELETE') }}
                                <button class="btn-sm btn btn-outline-danger delete-confirm" 
                                data-name ="{{$transaction->company}}" type="submit" style="margin-top: 5px">
                                Delete</button>
                            </form>
                        </td>
                      </tr>
