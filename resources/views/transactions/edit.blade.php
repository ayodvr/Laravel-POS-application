              ...
              <div class="padding-20">
                    ...
                    {{method_field('PUT')}}
                        ...
                        <div class="card-body">
                              ...
                              <div class="form-group col-md-6 col-12">
                                ...
                                <select name="account_id" class="form-control">
                                    @foreach($account as $account)
                                     <option value="{{$account->id}}" @if($account->id == $transaction->account_id) selected @endif>{{$account->company}}</option>
                                     @endforeach
                                 </select>
                              </div>
                            </div>
                            <div class="row">
                              <div class="form-group col-md-6 col-12">
                                ...
                                <input type="text" class="form-control" name="transaction_with" value="{{$transaction->transaction_with}}">
                              </div>
                              <div class="form-group col-md-6 col-12">
                      ...
                      <div class="card-footer text-center">
                        <button type="submit" class="btn btn-success">Edit Transaction</button>
                      </div>
                    </form>
              </div>
            </div>
